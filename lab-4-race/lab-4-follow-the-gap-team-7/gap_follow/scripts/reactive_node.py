...
class ReactiveFollowGap(Node):
    ...
    def __init__(self):
        ...
        self.lidar_window = 70
        self.lidar_max = 5.0
        self.dist_threshold = 1.2
        self.cliff_threshold = .03
        self.straight_threshold = 1.7
        self.rb = 5

        self.noturn_threshold = .23
    ...
    def find_best_point(self, start_i, end_i, ranges):
        ...
        # if np.max(ranges[start_i : end_i]) > self.straight_threshold:
        ...
        #nsi, nei = self.find_max_gap(ranges)

        #max_idx = int((nsi + nei) / 2)
